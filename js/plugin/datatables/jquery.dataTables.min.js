    ...
    !function (a) {
        ...
        function B(a) {
            ...
            var e = function (a, b, d) {
                ...
                if ("" !== d)for (var j = A(d), k = 0, l = j.length; l > k; k++) {
                    ...
                    if (g)j[k] = j[k].replace(qc, ""), a = a[j[k]](); else {
        ...
        function G(a, b, d, e) {
            ...
            if ("dom" !== d && (d && "auto" !== d || "dom" !== h.src)) {
                var i = h.anCells;
                if (i)for (f = 0, g = i.length; g > f; f++)i[f].innerHTML = y(a, b, f, "display")
            } else h._aData = H(a, h).data;
            h._aSortData = null, h._aFilterData = null;
            var j = a.aoColumns;
            if (e !== c)j[e].sType = null; else for (f = 0, g = j.length; g > f; f++)j[f].sType = null;
            J(h)
        }
        ...
        function H(a, b) {
            ...
            if (j)for (; j;)c = j.nodeName.toUpperCase(), ("TD" == c || "TH" == c) && n(j), j = j.nextSibling; else {
                i = b.anCells;
        ...
        function M(a) {
            ...
            if (a.bDeferLoading)a.bDeferLoading = !1, a.iDraw++, mb(a, !1); else if (k) {
        ...
        function O(a) {
            ...
            for (var h, i, j, k, l, m, n = a.sDom.split(""), o = 0; o < n.length; o++) {
                if (h = null, i = n[o], "<" == i) {
                    ...
                    g.append(j), g = d(j)
                } else if (">" == i)g = g.parent(); else if ("l" == i && f.bPaginate && f.bLengthChange)h = ib(a); else if ("f" == i && f.bFilter)h = W(a); else if ("r" == i && f.bProcessing)h = lb(a); else if ("t" == i)h = nb(a); else if ("i" == i && f.bInfo)h = cb(a); else if ("p" == i && f.bPaginate)h = jb(a); else if (0 !== Ub.ext.feature.length)for (var q = Ub.ext.feature, r = 0, s = q.length; s > r; r++)if (i == q[r].cFeature) {
                    h = q[r].fnInit(a);
                    break
                }
                if (h) {
        ...
        function P(a, b) {
            ...
            for (f = 0, i = o.length; i > f; f++)for (c = o[f], k = 0, e = c.firstChild; e;) {
                if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase())for (l = 1 * e.getAttribute("colspan"), m = 1 * e.getAttribute("rowspan"), l = l && 0 !== l && 1 !== l ? l : 1, m = m && 0 !== m && 1 !== m ? m : 1, j = p(a, f, k), n = 1 === l ? !0 : !1, h = 0; l > h; h++)for (g = 0; m > g; g++)a[f + g][j + h] = {cell: e, unique: n}, a[f + g].nTr = c;
                e = e.nextSibling
            }
        }
        ...
        function W(a) {
            var c = a.oClasses, e = a.sTableId, f = a.oPreviousSearch, g = a.aanFeatures, h = '<input type="search" class="' + c.sFilterInput + '"/>', i = a.oLanguage.sSearch;
            i = i.match(/_INPUT_/) ? i.replace("_INPUT_", h) : i + h;
            var j = d("<div/>", {id: g.f ? null : e + "_filter", "class": c.sFilter}).append(d("<label/>").append(i)), k = function () {
        ...
        function Y(a) {
            for (var b, c, d = Ub.ext.search, e = a.aiDisplay, f = 0, g = d.length; g > f; f++)for (var h = e.length - 1; h >= 0; h--)c = e[h], b = a.aoData[c], d[f](a, b._aFilterData, c, b._aData) || e.splice(h, 1)
        }
        ...
        function $(a, b, c, d, e, f) {
            ...
            if (0 !== Ub.ext.search.length && (c = !0), h = bb(a), b.length <= 0)a.aiDisplay = l.slice(); else for ((h || c || k.length > b.length || 0 !== b.indexOf(k) || a.bSorted) && (a.aiDisplay = l.slice()), g = a.aiDisplay, i = g.length - 1; i >= 0; i--)j.test(a.aoData[g[i]]._sFilterRow) || g.splice(i, 1)
        }
        ...
        function ib(a) {
            for (var b = a.oClasses, c = a.sTableId, e = a.aLengthMenu, f = d.isArray(e[0]), g = f ? e[0] : e, h = f ? e[1] : e, i = d("<select/>", {name: c + "_length", "aria-controls": c, "class": b.sLengthSelect}), j = 0, k = g.length; k > j; j++)i[0][j] = new Option(h[j], g[j]);
        ...
        function qb(b) {
            ...
            if (w || m || l || p != q(b) || p != t.length) {
                ...
                if (b.aoData.length)for (c = 0; c < s.length; c++)f = s[c], e = j[f], d(ub(b, f)).clone(!1).append(e.sContentPadding).appendTo(y);
            ...
            } else for (c = 0; p > c; c++)j[c].sWidth = wb(t.eq(c).width());
        ...
        function yb(a) {
            ...
            for (d.isArray(l) && o(l), m && l.pre && o(l.pre), o(a.aaSorting), m && l.post && o(l.post), b = 0; b < n.length; b++)for (i = n[b][0], f = k[i].aDataSort, c = 0, e = f.length; e > c; c++)g = f[c], h = k[g].sType || "string", j.push({src: i, col: g, dir: n[b][1], index: n[b][2], type: h, formatter: Ub.ext.type.order[h + "-pre"]});
            return j
        }
        ...
        var Ub, Vb, Wb, Xb, Yb, Zb = {}, $b = /[\r\n]/g, _b = /<.*?>/g, ac = /^[\d\+\-a-zA-Z]/, bc = new RegExp("(\\" + ["/", ".", "*", "+", "?", "|", "(", ")", "[", "]", "{", "}", "\\", "$", "^", "-"].join("|\\") + ")", "g"), cc = /[',$£€¥%\u2009\u202F]/g, dc = function (a) {
            ...
            if (e !== c)for (; h > g; g++)f.push(a[b[g]][d][e]); else for (; h > g; g++)f.push(a[b[g]][d]);
            return f
        }, lc = function (a, b) {
            var d, e = [];
            b === c ? (b = 0, d = a) : (d = b, b = a);
        ...
        Ub = function (a) {
            ...
            return this.each(function () {
                ...
                if (0 !== I.length && (P(A.aoHeader, I[0]), G = Q(A)), null === p.aoColumns)for (F = [], q = 0, n = G.length; n > q; q++)F.push(null); else F = p.aoColumns;
                ...
                if (0 === R.length && M.length > 0 && ("" !== A.oScroll.sX || "" !== A.oScroll.sY) && (R = d("<tfoot/>").appendTo(this)), 0 === R.length || 0 === R.children().length ? d(this).addClass(B.sNoFooter) : R.length > 0 && (A.nTFoot = R[0], P(A.aoFooter, A.nTFoot)), p.aaData)for (q = 0; q < p.aaData.length; q++)u(A, p.aaData[q]); else(A.bDeferLoading || "dom" == Qb(A)) && v(A, d(A.nTBody).children("tr"));
        ...
        Ub.Api = Wb = function (a, b) {
            ...
            if (vc.forEach)vc.forEach.call(this, a, this); else for (var b = 0, c = this.length; c > b; b++)a.call(this, this[b], b, this);
            return this
        }, eq: function (a) {
            var b = this.context;
            ...
            var b = [];
            if (vc.filter)b = vc.filter.call(this, a, this); else for (var c = 0, d = this.length; d > c; c++)a.call(this, this[c], c, this) && b.push(this[c]);
            ...
            var b = [];
            if (vc.map)b = vc.map.call(this, a, this); else for (var c = 0, d = this.length; d > c; c++)b.push(a.call(this, this[c], c));
            return new Wb(this.context, b)
        }, pluck: function (a) {
            ...
            if (d.isArray(a))for (var c = 0, e = a.length; e > c; c++)Wb.register(a[c], b); else {
        ...
        var zc = function (a, b) {
            var e, f, g, h, i, j, k = [];
            for (a && "string" != typeof a && a.length !== c || (a = [a]), g = 0, h = a.length; h > g; g++)for (f = a[g] && a[g].split ? a[g].split(",") : [a[g]], i = 0, j = f.length; j > i; i++)e = b("string" == typeof f[i] ? d.trim(f[i]) : f[i]), e && e.length && k.push.apply(k, e);
            return k
        }, Ac = function (a) {
            ...
            }); else if ("index" == k || "original" == k)for (c = 0, e = a.aoData.length; e > c; c++)"none" == j ? g.push(c) : (f = d.inArray(c, h), (-1 === f && "removed" == j || 1 === f && "applied" == j) && g.push(c));
            return g
        }, Dc = function (a, b, c) {
        ...
        var Kc = function (a, b, c) {
            ...
            return zc(b, function (a) {
                if (!a) {
                    for (f = [], g = 0, h = k.length; h > g; g++)for (e = k[g], i = 0; n > i; i++)f.push({row: e, column: i});
                    return f
                }
        ...
        Xb("cells()", function (a, b, e) {
            ...
            for (var b, c, d = Ub.version.split("."), e = a.split("."), f = 0, g = e.length; g > f; f++)if (b = parseInt(d[f], 10) || 0, c = parseInt(e[f], 10) || 0, b !== c)return b > c;
            return!0
